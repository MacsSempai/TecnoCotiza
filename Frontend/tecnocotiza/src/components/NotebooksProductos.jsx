...
const normalizeData = (data) => {  
  return data.map(product => ({
    ...
    images: product.images || product.imagess_urls || [],
...
const NotebooksProductos = () => {
  ...
  const Categoria_notebook = ['Computadores', 'PC y Portatiles'];

  const productosFiltrados = productos.filter(producto =>
    producto.price >= precioMinimo &&
    Categoria_notebook.includes(producto.category)
  );
