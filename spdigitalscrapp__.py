...
def extraer_info_del_sitemap_limitado(sitemap_url, limite_urls=30):
    ...
    precio_historico_collection = db["precioHistorico"]
            ...
            for url in urls:
                try:
                    ...
                    if (response.status_code == 200):
                        ...
                        # Preparar el documento del producto a insertar
                        product_document = {
                            "url": url,
                        ...
                        # Insertar el documento del producto en MongoDB
                        products_collection.insert_one(product_document)
                        
                        # Preparar el documento del precio histórico a insertar
                        precio_historico_document = {
                            "url": url,
                            "name": nombre_producto,
                            "price": precio_producto
                        }
                        
                        # Insertar el documento del precio histórico en MongoDB
                        precio_historico_collection.insert_one(precio_historico_document)
                        
                        # Preparar el documento de la tienda a insertar
                        tienda_document = {
                            "url": url,
                            "name": nombre_producto,
                            "store": "spdigital"
                        ...
                        # Insertar el documento de la tienda en MongoDB
                        tiendas_collection.insert_one(tienda_document)
